# Project 5 - Little Birdie

Little Birdie is a basic twitter app to read and compose tweets the [Twitter API](https://apps.twitter.com/).
...
1. How to get/unwrap the user object more easily
2. Possibly creating a toggle for light or dark mode like real Twitter
