...
1. Getting the images to be stored using a URL instead of relying on ParseUI
2. Implementing sharing of posts
...
- Getting the Parse pod to work
- Properly saving and retrieving the data from the backend
- Laying out the constraints properly
