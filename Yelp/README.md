...
1. Tapping on the images in the table view could bring up a larger one in a modal.
2. There could be a collection view where all the user sees is the food images, so they could choose based on visual appeal.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='./user-stories.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
